...
![image-20240810094956378](C:\Users\24937\Desktop\学习\笔记\assets\image-20240810094956378.png)
...
- 先写登陆页面,login_msgboard.php(html和php代码放在一起的,但是实质上我是先写html文件,然后在把html代码粘贴过来),我们先创建一个叫``login_msgboard.html``来写html,写完后复制粘贴然后删了.
  ...
  ![image-20240810095622895](C:\Users\24937\Desktop\学习\笔记\assets\image-20240810095622895.png)
  ...
  - 我们看一看效果(图片可以自己去找,bootstrap可以去https://v3.bootcss.com/getting-started/这里下载)
    ...
    ![image-20240810101554215](C:\Users\24937\Desktop\学习\笔记\assets\image-20240810101554215.png)
...
- 在html下面开始写php
  ...
  ![image-20240810101954459](C:\Users\24937\Desktop\学习\笔记\assets\image-20240810101954459.png)
...
- 命令 ``create database msgboard;``
  ...
  ![image-20240810103816469](C:\Users\24937\Desktop\学习\笔记\assets\image-20240810103816469.png)
...
- 注册页面毋庸置疑,样式肯定跟登陆页面差不多,我这里写的不算很好,常规的写法是密码需要输入两次确认是否一致.相对登录页面来说书写简单些
  ...
  ![image-20240810105648664](C:\Users\24937\Desktop\学习\笔记\assets\image-20240810105648664.png)
...
- 看一看效果
  ...
  ![image-20240810105817385](C:\Users\24937\Desktop\学习\笔记\assets\image-20240810105817385.png)

### register.php设计

- 同理将注册页面的html放入php文件里

![image-20240810105950416](C:\Users\24937\Desktop\学习\笔记\assets\image-20240810105950416.png)
...
![image-20240810112041763](C:\Users\24937\Desktop\学习\笔记\assets\image-20240810112041763.png)
...
![image-20240810113618361](C:\Users\24937\Desktop\学习\笔记\assets\image-20240810113618361.png)
